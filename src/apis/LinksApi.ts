...
import {
    ...
    LinkFromJSON,
    LinkToJSON,
    ListLinks200ResponseFromJSON,
    ListLinks200ResponseToJSON,
} from '../models/index';
...
export class LinksApi extends runtime.BaseAPI {
     ...
     * Create a link
     */
    async createLink(requestParameters: CreateLinkOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Link> {
     ...
     * Edit a link
     */
    async editLink(requestParameters: EditLinkOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Link> {
     ...
     * List links
     */
    async listLinks(requestParameters: ListLinksRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ListLinks200Response> {
