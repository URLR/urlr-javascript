...
import {
    CreateLink201ResponseFromJSON,
    CreateLink201ResponseToJSON,
...
export class LinksApi extends runtime.BaseAPI {
     ...
     * Create a link
     */
    async createLinkRaw(requestParameters: CreateLinkOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateLink201Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => CreateLink201ResponseFromJSON(jsonValue));
    }

    /**
     * Create a link
     */
    async createLink(requestParameters: CreateLinkOperationRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateLink201Response> {
    ...
    async getLinkRaw(requestParameters: GetLinkRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetLink200Response>> {
        ...
        const response = await this.request({
            path: `/links/{link_id}`.replace(`{${"link_id"}}`, encodeURIComponent(String(requestParameters['linkId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
